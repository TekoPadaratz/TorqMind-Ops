...
- Flyway aplicado até **V17** (geolocalização opcional dos anexos / `task_attachments.latitude,longitude`); config por empresa = V16; senha = V15; voz = V12; qualidade combustível = V14
