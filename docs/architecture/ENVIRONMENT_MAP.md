...
- Flyway aplicado até **V19** (segredo TOTP cifrado em repouso / `totp_secret` VARCHAR(255)); 2FA opt-in = V18; geolocalização dos anexos = V17; config por empresa = V16; senha = V15; voz = V12; qualidade combustível = V14
