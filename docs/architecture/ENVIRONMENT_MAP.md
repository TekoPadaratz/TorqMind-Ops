...
- Flyway aplicado até **V18** (2FA opt-in / `auth_users.totp_secret,totp_enabled`); geolocalização dos anexos = V17; config por empresa = V16; senha = V15; voz = V12; qualidade combustível = V14
