...
/**
 * Cifra genérica de string em repouso (AES-GCM). Compatível com valores legados em texto puro
 * (leitura sem o prefixo "gcm:" retorna como está). Chave: TOTP_ENC_KEY (base64 32 bytes) ou
 * derivada de JWT_SECRET via SHA-256.
 */
@Converter
public class EncryptedStringConverter implements AttributeConverter<String, String> {
    ...
    public String convertToDatabaseColumn(String attribute) {
        ...
        try {
            ...
            throw new IllegalStateException("Falha ao cifrar valor.", ex);
        }
    }
    ...
    public String convertToEntityAttribute(String dbData) {
        ...
        try {
            ...
            throw new IllegalStateException("Falha ao decifrar valor.", ex);
        }
    }
    ...
    private static SecretKey resolveKey() {
        try {
            ...
            throw new IllegalStateException("Falha ao derivar chave de cifra.", ex);
        }
    }
}
